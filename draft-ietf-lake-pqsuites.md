...
This document specifies how the LAKE protocol operates in a post-quantum setting by defining new cipher suites using ML-KEM {{I-D.ietf-jose-pqc-kem}} for key exchange and ML-DSA {{I-D.ietf-cose-dilithium}} for digital signatures. ML-KEM provides a post-quantum replacement for the ephemeral Diffie-Hellman key exchange. The new cipher suites can be used with signature-based authentication, as well as with the PSK-based and KEM-based authentication methods being developed.
